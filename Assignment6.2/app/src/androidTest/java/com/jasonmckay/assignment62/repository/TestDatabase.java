package com.jasonmckay.assignment62.repository;

import android.test.AndroidTestCase;

import com.jasonmckay.assignment62.config.database.DBContract;
import com.jasonmckay.assignment62.config.util.App;
import com.jasonmckay.assignment62.factories.manufacturer.Manufacturer;
import com.jasonmckay.assignment62.repository.repositoryManufacturer.RepositoryManufacturer;
import com.jasonmckay.assignment62.repository.repositoryManufacturer.impl.RepositoryManufacturerImpl;
...
public class TestDatabase extends AndroidTestCase
{
    ...
    public void testDatabase() throws Exception
    {
        ...
        entity.print();
        Assert.assertEquals("Diesel", entity.getEngineType());
